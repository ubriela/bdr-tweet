...
for ij in xrange(len(disaster_array)):
    ...
    manually_verified_hashtags = [
        ...
        all_flood_keywords + " | pwnwstorm | itssortawindy | thestorm | duststorm | wawind | storme | windblowsmyfaceoff | calmafterthestorm | windschief | storm | windy | bringonthestorm | morningstorm | wind | windyinseattle | windfarm | windenergy | windycity | wawindstorm | Summerstormproblems | windrainorshine | calmbeforethestorm | stormyweather | quietstorm | unwind | SeattleStormageddon | storm2015 | dirtstorm | windstorm | Thunderstorm | holywindbatman | nameourstorms | windydays | stormynights | stormwatch",
        all_fire_keywords,
